...
/**
 * Owner review queue for player feature requests.
 * TODO(auth): gate to the universe owner once Google login lands.
 */
export default function RequestsPage() {
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-10">
      <h1 className="text-2xl font-bold text-accent">Feature requests</h1>
