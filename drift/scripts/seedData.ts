...
export const npcs: Npc[] = [
  ...
  { id: "npc-quist", universeId: UNIVERSE_ID, name: "Harbormaster Quist", oneBreath: "Halcyon's harbormaster — keeps the freeport neutral by force of reputation; knows every hull, every debt, and every crew that passes through, and trades berths for favors.", factionId: "f-free", locationId: "loc-freeport", role: "harbormaster" },
  { id: "npc-brekk", universeId: UNIVERSE_ID, name: "Quartermaster Brekk", oneBreath: "Coldharbor's quartermaster — runs the Sable Chain's staging docks with cold efficiency; always short on reliable hands for runs onto the Crown lanes. Pays fast, asks twice as much next time.", factionId: "f-sable", locationId: "loc-sable", role: "Sable quartermaster" },
  { id: "npc-osk", universeId: UNIVERSE_ID, name: "Foreman Osk", oneBreath: "Cinderhaul's dock foreman — twenty years of slag and short pay; keeps the ore moving and quietly shields his crews from the syndicate collectors when he can.", locationId: "loc-cinder", role: "dock foreman" },
  { id: "npc-ismay", universeId: UNIVERSE_ID, name: "Warden Ismay", oneBreath: "The Wake's warden — a Reclaimer who logs every hull in the graveyard and decides who salvages where; superstitious about the wrecks, and rightly so.", factionId: "f-reclaimers", locationId: "loc-wake", role: "graveyard warden" },
