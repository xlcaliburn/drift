...
function ReSyncButton({ campaignId, onSynced }: { campaignId: string; onSynced?: () => void }) {
...
function AimEditor({ campaignId, initial, onSaved }: { campaignId: string; initial: string; onSaved?: () => void }) {
