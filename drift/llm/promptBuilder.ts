...
Respond with ONE json object and nothing else:
{
  ...
  "combatStart": {"enemies": [{"tier": "T3", "count": 1, "name": "Calvo"}, {"tier": "T2", "count": 2, "name": "heavy"}], "surprise": "none"},
...
{"narration":"Your hand's already moving — the pistol clears leather as Calvo barks an order and his two heavies reach for their own iron. The cargo bay goes loud and bright.","combatStart":{"enemies":[{"tier":"T3","count":1,"name":"Calvo"},{"tier":"T2","count":2,"name":"heavy"}],"surprise":"player"}}`;
