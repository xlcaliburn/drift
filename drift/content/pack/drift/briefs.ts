import type { PackBriefs } from "../types";

/**
 * Player-facing onboarding text — the world primer, the season spine, and the
 * per-faction briefs shown during creation. Moved verbatim from
 * content/briefs.ts (Modularity M1 Task E); content/briefs.test.ts pins it.
 */
export const driftBriefs: PackBriefs = {
  worldIntro:
